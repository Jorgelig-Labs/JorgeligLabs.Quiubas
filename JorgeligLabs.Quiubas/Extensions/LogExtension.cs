...
namespace JorgeligLabs.Quiubas.Extensions
{
...
public static void Enter(this ILogger logger,
            ...
            [CallerLineNumber] int callerLineNumber = 0)
        {
            using (var compositeDisposable = new CompositeDisposable())
            {
                ...
                {
                    LogContext.PushProperty("Arguments", arguments, destructureObjects: true)
                ...
                if (exception != null)
                {
                    ...
                    LogContext.PushProperty("Exception", exception, destructureObjects: true)
                        .DisposeWith(compositeDisposable);
                }

                LogContext.PushProperty("ReturnValue", returnValue, destructureObjects: true)
                    .DisposeWith(compositeDisposable);
                ...
                if (propertyValues != null)
                {
                    ...
                    {
                        LogContext.PushProperty(propertyValue.Name, propertyValue.Value)
                            .DisposeWith(compositeDisposable);
                    }
                }
